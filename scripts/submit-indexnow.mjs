...
const [newsSource, insightsSource, palladyneSource, plusOneSource, antiochSource, physicalAiFundsSource, mexicoSource, manufacturingSeriesSource, manufacturingPlantSource] = await Promise.all([
