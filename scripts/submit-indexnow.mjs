...
const [newsSource, insightsSource, palladyneSource, foxgloveSource, plusOneSource, antiochSource, physicalAiFundsSource, mexicoSource, manufacturingSeriesSource, manufacturingPlantSource, manufacturingMachinesSource, productManufacturingSource, factoryBuildersSource, manufacturingPlantDesignSource, industrialAutomationSource, physicalAiManufacturingSource, manufacturingPlantBuildSource, robotActuatorsSource, whatIsPhysicalAiSource, digitalTwinsSource] = await Promise.all([
  ...
  readFile(new URL("../lib/foxglove.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/plus-one-robotics.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/antioch.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/physical-ai-venture-funds.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/mexico-automation.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/manufacturing-physical-ai-series.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/manufacturing-plant-deep-dive.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/manufacturing-machines-guide.ts", import.meta.url), "utf8"),
  ...
  readFile(new URL("../lib/physical-ai-manufacturing-guide.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/manufacturing-plant-build-guide.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/robot-actuators.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/what-is-physical-ai.ts", import.meta.url), "utf8"),
  readFile(new URL("../lib/digital-twins.ts", import.meta.url), "utf8"),
]);
