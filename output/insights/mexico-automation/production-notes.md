...
The final revision takes a twenty year view of Mexico's economy, tracing the effects of a sustained loss of manufacturing competitiveness through suppliers, employment, household income, external finances, fiscal capacity and domestic industrial capability. Rodolfo's illustrative 20 times cost gap is not used as an assumed statistic or required threshold. The futures figure now shows the two possible economic paths over twenty years. Added primary economic research on divergence and trade, preserving its theoretical or historical scope. Final article: approximately 5,342 words, 17 sections, 15 linked sources, four supporting figures and the Mexico cover.
