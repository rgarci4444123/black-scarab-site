...
const sources = {
  ...
  divergence: "https://www.imf.org/en/publications/wp/issues/2020/09/11/will-the-ai-revolution-cause-a-great-divergence-49734",
  tradeAutomation: "https://blogs.worldbank.org/en/developmenttalk/what-does-rise-robots-mean-trade",
};
...
export const mexicoAutomationDeepDive = (): CaseStudyArticle => ({
  ...
  modifiedAt: "2026-09-12T16:38:00Z",
  typeLabel: "Deep Dive",
  formatLabel: "Industrial strategy and manufacturing economics",
  industry: "Manufacturing",
  image: "/article-images/mexico-automation/mexico-adoption-cover.png",
  imageFit: "contain",
  imageAlt: "Editorial collage of Mexico’s outline connecting machine vision, robotic manufacturing and autonomous warehouse logistics",
  imageCaption: "Original AI generated editorial illustration by Black Scarab depicting physical AI adoption across Mexico’s industrial economy. Connections are conceptual.",
  ...
  sections: [
    ...
    {
      heading: "China is raising the competitive benchmark",
      paragraphs: [
        ["China’s manufacturing strength gives Mexico little room for complacency. In February 2026, the ", { text: "IMF described robust Chinese exports alongside weak domestic demand", href: sources.china }, ". Expanding consumption and upgrading production can reinforce one another: a larger domestic market supports industrial scale, while better factories remain formidable competitors abroad."],
        ["The IFR’s ", { text: "World Robotics 2025 report", href: sources.robots }, " records about 295,000 industrial robot installations in China during 2024, compared with 34,200 in the United States and 5,600 in Mexico. China represented 54 percent of worldwide installations. Mexican installations declined 4 percent, with automotive accounting for 63 percent. Mexico’s task is to broaden adoption across the industrial base while its largest global competitors keep investing."],
    ...
    {
      heading: "Two different Mexican economies in twenty years",
      paragraphs: [
      ...
      visual: {
        src: "/article-images/mexico-automation/futures-long-term.png",
        alt: "Two twenty year scenarios: delayed adoption weakens industrial clusters and pressures incomes and public finances; sustained adoption builds competitive suppliers, productive work and local capability.",
        caption: "Black Scarab scenarios over a twenty year horizon. The paths illustrate how successive investment decisions can change the economy; they are not forecasts or assigned probabilities.",
      },
    },
    {
      heading: "When an industrial advantage erodes, the whole country pays",
      paragraphs: [
    ...
    {
      heading: "Mexico belongs in the global robotics growth strategy",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ["Mexico has policy tools on which to build. Hacienda’s ", { text: "Plan México tax incentive summary", href: sources.policy }, " describes accelerated deductions for qualifying new fixed assets and additional deductions related to training and innovation. Subject to project eligibility, these measures can support the investment and workforce development that a broader modernization effort requires."],
    ...
    },
    {
      ...
      paragraphs: [
        ["Manufacturing generated approximately 20.1 percent of Mexico’s GDP in 2024, according to the ", { text: "World Bank’s manufacturing value added series", href: sources.gdp }, ". With roughly one fifth of the economy tied directly to manufacturing, the ability to retain and expand production is a national economic priority."],
        ["The employment stakes are equally substantial. ", { text: "INEGI reported", href: sources.jobs }, " 9.7 million people working in manufacturing in October 2024, or 16.3 percent of employment. Decisions about the next factory program reach beyond the plant into household income, supplier businesses and the prospects of industrial communities."],
    ...
    {
      heading: "Turning adoption into a durable advantage",
      paragraphs: [
        ["Automation can also expand the market for capable suppliers. ", { text: "World Bank research summarized in 2019", href: sources.tradeAutomation }, " found that robot adoption in advanced economies was associated with greater imports from developing countries, including intermediate goods. Mexico can participate in that growth by remaining a competitive part of the production network. The strategic risk is falling behind as that network becomes more demanding."],
  ...
  sources: ["IFR World Robotics 2025", "USTR", "Federal Reserve Bank of Dallas", "IMF", "OECD", "INEGI", "Hacienda", "Associated Press", "Association for Advancing Automation"],
  sourceLinks: [
    ...
    { label: "Alonso, Berg, Kothari, Papageorgiou and Rehman, IMF Working Paper 20/184, September 11, 2020. Automation and economic divergence", url: sources.divergence },
    { label: "Rijkers, Bastos and Artuc, World Bank, April 4, 2019. Robot adoption and trade", url: sources.tradeAutomation },
  ],
});
