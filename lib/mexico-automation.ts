...
const sources = {
  robots: "https://ifr.org/worldrobotics/report-2025",
  stock: "https://ifr.org/downloads/press_docs/2025-09-25-IFR_press_release_Americas_in_English.pdf",
  trade: "https://www.ustr.gov/countries-regions/americas/mexico",
  fed: "https://www.dallasfed.org/research/economics/2026/0512",
  investment: "https://www.dallasfed.org/research/economics/2024/1205",
  china: "https://www.imf.org/en/news/articles/2026/02/18/cf-how-chinas-economy-can-pivot-to-consumption-led-growth",
  review: "https://www.ustr.gov/about/policy-offices/press-office/press-releases/2026/july/united-states-and-mexico-convene-mexico-city-third-bilateral-negotiating-round-related-joint-review",
  ap: "https://apnews.com/article/usmca-mexico-canada-trade-nafta-4531f12f1a59cb2b2e20bcdbdd9d47b5",
  oecd: "https://www.oecd.org/en/publications/harnessing-nearshoring-opportunities-in-mexico-by-boosting-productivity-and-fighting-climate-change_0ca7fc0a-en.html",
  plus: "https://www.plusonerobotics.com/blog/rfm-jack-of-all-trades-or-aces",
  a3: "https://www.automate.org/robotics/industry-insights/the-rise-of-automation-in-mexico-digital-transformation-redefines-emerging-industries",
  exports: "https://www.inegi.org.mx/app/tabulados/default.html?idrt=8&nc=550&opc=t",
  policy: "https://www.estimulosfiscales.hacienda.gob.mx/es/efiscales_mediante_decreto/Plan_Mexico",
  jobs: "https://www.inegi.org.mx/contenidos/saladeprensa/boletines/2024/IOE/IOE2024_12.pdf",
  gdp: "https://data.worldbank.org/indicator/NV.IND.MANF.ZS?locations=MX",
};
...
export const mexicoAutomationDeepDive = (): CaseStudyArticle => ({
  ...
  summary: "Nearshoring bought Mexico an opening. Automation will help decide whether it becomes a lasting industrial advantage or a temporary stop on the way to someone else’s factory.",
  publishedLabel: "Deep Dive · Published September 12, 2026",
  publishedDate: "2026-09-12",
  publishedAt: "2026-09-12T08:15:00-04:00",
  typeLabel: "Deep Dive",
  formatLabel: "Industrial strategy and manufacturing economics",
  industry: "Manufacturing",
  image: "/article-images/mexico-automation/cover.png",
  imageAlt: "Original editorial illustration of an industrial factory in Mexico being upgraded with robotic manufacturing cells",
  imageCaption: "Original AI generated editorial illustration by Black Scarab. This is an interpretation, not a photograph of a real factory.",
  seoDescription: "Mexico’s manufacturing advantage faces an automation test. Explore robot adoption, nearshoring, factory economics and the opportunity for physical AI companies.",
  tags: ["Mexico", "physical AI", "nearshoring", "industrial automation", "manufacturing", "robotics"],
  ...
  sections: [
    ...
    {
      heading: "A valuable relationship with unequal exposure",
      paragraphs: [
        ["The United States bought $534.3 billion of goods from Mexico in 2025 and sold it $337.3 billion, putting bilateral goods trade at $871.6 billion. More than 80 percent of Mexican goods exports went to the United States in 2024, according to ", { text: "USTR’s trade summary", href: sources.trade }, ". The two countries are deeply connected, but Mexico’s export dependence makes the exposure asymmetric."],
        ...
        ["USTR’s ", { text: "July 2026 negotiating agenda", href: sources.review }, " explicitly included automotive rules of origin, steel and aluminum, economic security and other bilateral issues. Associated Press reporting at the start of the review described an uncertain negotiation that could extend for months. ", { text: "AP’s account", href: sources.ap }, " provides independent context for the commercial uncertainty."],
      ...
      visual: {
        src: "/article-images/mexico-automation/trade.png",
        alt: "US goods imports from Mexico were 534.3 billion dollars and exports to Mexico were 337.3 billion dollars in 2025. More than 80 percent of Mexican goods exports went to the US in 2024.",
        caption: "Black Scarab chart using USTR data. Dollar flows cover 2025; the export destination share covers 2024. Gross trade flows are not domestic value added or GDP.",
      },
    },
    {
      heading: "Nearshoring is an opening, not a completed transformation",
      paragraphs: [
        ["Research published by Dallas Fed economists in May 2026 finds that trade diversion from China produced a sustained increase in Mexican output. Their model estimates a GDP level gain of about 1.1 percentage points when investment adjusts, versus about 0.4 percentage points with a fixed capital stock. These are model estimates of trade spillovers, not observed annual growth rates or an automation forecast. ", { text: "Dallas Fed analysis", href: sources.fed }, "."],
    ...
    },
    {
      ...
      visual: {
        src: "/article-images/mexico-automation/robots.png",
        alt: "Industrial robot installations in 2024: China 295000, United States 34200, Mexico 5600, on a shared linear scale.",
        caption: "Original Black Scarab chart using rounded IFR World Robotics 2025 figures for calendar 2024. These counts do not measure AI adoption, productivity or robots per worker.",
      },
    },
    {
      heading: "The threshold is delivered cost per good unit",
      paragraphs: [
        ...
        ["The claim that humans remain universally faster than machines does not hold. Plus One Robotics says its specialized InductOne parcel system routinely exceeds 2,500 to 3,200 inducted items per hour in ", { text: "its discussion of robot foundation models", href: sources.plus }, ". That is a vendor claim, not an independent benchmark. Parcel mix, staffing, exception handling and operating conditions matter, and it cannot establish a general human versus robot ranking."],
    ...
    {
      heading: "The decision to upgrade versus rebuild",
      paragraphs: [
      ...
      visual: {
        src: "/article-images/mexico-automation/economics.png",
        alt: "Hypothetical ten year present costs: continue in Mexico 6.14 million dollars, upgrade Mexico 5.50 million, new US capacity 6.38 million, and lower capital cost US capacity 5.38 million.",
        caption: "Black Scarab hypothetical investment model, not observed plant costs or a forecast. Ten years, 10 percent discount rate, equal output, year end operating costs and no terminal value. Assumptions and exclusions are explained above.",
      },
      tables: [{
        title: "Hypothetical sensitivity to the discount rate",
        columns: ["Annual discount rate", "Continue in Mexico", "Upgrade Mexico", "US alternative at $3 million"],
        rows: [
        ...
        note: "Present cost equals initial investment plus annual operating cost multiplied by the ten year annuity factor. Lower present cost is preferred only under the equal output assumptions.",
      }],
    },
    {
      heading: "Two paths through the next investment cycle",
      paragraphs: [
      ...
      visual: {
        src: "/article-images/mexico-automation/futures.png",
        alt: "Two conditional paths: delayed upgrades lead to weaker bids and capacity awarded elsewhere; sustained upgrades lead to stronger performance and more competitive expansion bids. Both remain exposed to trade and demand risk.",
        caption: "Black Scarab scenario diagram. These are conditional mechanisms over successive investment cycles, not predicted dates, probabilities or GDP trajectories.",
      },
    },
    {
      heading: "The first projects should solve expensive problems",
      paragraphs: [
      ...
      tables: [{
        title: "A practical first deployment screen",
        columns: ["Application", "What to measure", "What can defeat the case"],
        rows: [
        ...
        note: "Black Scarab application framework. These are potential use cases, not claims of deployments by named customers.",
      }],
    },
    {
      heading: "The factory stack must survive the real plant",
      paragraphs: [
    ...
    {
      heading: "A market entry strategy built around repeatability",
      paragraphs: [
    ...
    {
      heading: "Industrial policy has to reach beyond the robot",
      paragraphs: [
        ["Mexico already has investment incentives. Hacienda’s ", { text: "Plan México tax incentive summary", href: sources.policy }, " describes accelerated deductions for qualifying new fixed assets and additional deductions related to training and innovation. These are conditional tax provisions, not a universal robotics grant or proof that a nationwide automation program will be funded. Eligibility and the applicable rules need to be checked for each project."],
        ...
        ["The ", { text: "OECD’s research on nearshoring", href: sources.oecd }, " identifies transport and digital connectivity, regulation, the rule of law, renewable energy and water scarcity as constraints. A plant full of advanced equipment still needs reliable utilities and a dependable route to market."],
    ...
    {
      heading: "The workforce is part of the advantage",
      paragraphs: [
        ["Manufacturing generated approximately 20.1 percent of Mexico’s GDP in 2024, according to the ", { text: "World Bank’s manufacturing value added series", href: sources.gdp }, ". That supports the description of roughly one fifth of the economy. It does not mean that gross exports equal domestic income or that the entire sector is at risk of disappearing."],
        ["INEGI reported 9.7 million people working in manufacturing in October 2024, or 16.3 percent of employment. This is a dated employment observation, not a current headcount or the manufacturing share of GDP. ", { text: "INEGI labor indicators", href: sources.jobs }, ". The scale explains why industrial competitiveness extends well beyond individual factory margins."],
    ...
    {
      heading: "What would weaken this thesis",
      paragraphs: [
        ...
        ["A3’s September 2026 ", { text: "industry report on Mexican automation", href: sources.a3 }, " describes an established manufacturing platform and interviews automation suppliers about growing demand. That is evidence of an active market, with the perspective of an industry association, not proof of universal adoption or guaranteed returns."],
    ...
    {
      heading: "Sources and analytical method",
      paragraphs: [
  ...
  sources: ["IFR World Robotics 2025", "USTR", "Federal Reserve Bank of Dallas", "IMF", "OECD", "INEGI", "Hacienda", "Associated Press", "Plus One Robotics", "Association for Advancing Automation"],
  sourceLinks: [
    { label: "IFR, World Robotics 2025, September 25, 2025. Calendar 2024 installations", url: sources.robots },
    { label: "IFR, Americas release, September 25, 2025. Operational stocks and adoption", url: sources.stock },
    { label: "USTR, Mexico trade summary, accessed September 12, 2026. 2025 trade and 2024 exposure", url: sources.trade },
    { label: "Reyes Heroles, Torres and Morales Burnett, Dallas Fed, May 12, 2026. Trade spillover model", url: sources.fed },
    { label: "Dallas Fed, December 5, 2024. Nearshoring and investment composition", url: sources.investment },
    { label: "IMF, February 18, 2026. China’s consumption transition", url: sources.china },
    { label: "USTR, July 17, 2026. Third bilateral negotiating round agenda", url: sources.review },
    { label: "Associated Press, June 30, 2026. North American trade negotiations", url: sources.ap },
    { label: "González Pandiella and Maravalle, OECD, May 7, 2024. Nearshoring constraints", url: sources.oecd },
    { label: "Plus One Robotics, accessed September 12, 2026. Vendor throughput claims", url: sources.plus },
    { label: "A3, September 4, 2026. Automation in Mexico and supplier interviews", url: sources.a3 },
    { label: "Hacienda, Plan México incentives, accessed September 12, 2026", url: sources.policy },
    { label: "INEGI, December 2024 labor release. October 2024 manufacturing employment", url: sources.jobs },
    { label: "World Bank, World Development Indicators, 2024 manufacturing value added; retrieved September 12, 2026", url: sources.gdp },
  ],
});
